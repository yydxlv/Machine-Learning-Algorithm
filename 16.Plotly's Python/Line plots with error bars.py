...
mean_PlyCount = sliding_mean(chess_data.groupby("Year").PlyCount.mean().values,window=10)
sem_PlyCount = sliding_mean(chess_data.groupby("Year").PlyCount.apply(sem).mul(1.96).values,window=10)
...
plt.xlabel("\nData source: www.ChessGames.com", fontsize=10)

# Finally, save the figure as a PNG.
# You can also save it as a PDF, JPEG, etc.
# Just change the file extension in this call.
# bbox_inches="tight" removes all the extra whitespace on the edges of your plot.
plt.savefig("evolution-of-chess/chess-number-ply-over-time.png", bbox_inches="tight")
